...
project = 'Forlinx Embedded T527 Documentation'
...
latex_documents = [
(
'OK527N-C_Linux5.15.47_User_Compilation_Manual',	        # (修改) md文件名，无后缀
'OK527N-C_Linux5.15.47_User_Compilation_Manual.tex',      # (修改) 与md文件名保持一致，后缀.tex
'FET527N-C OK527N-C',                                     # (修改) PDF说明书封面标题
...
'OK527N-C_Linux5.15.47_User_Manual.tex',
'FET527N-C OK527N-C',

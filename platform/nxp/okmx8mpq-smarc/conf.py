...
latex_documents = [
(
'OK-MX8MPQ-SMARC_Hardware_Manual',	        # (修改) md文件名，无后缀
'OK-MX8MPQ-SMARC_Hardware_Manual.tex',      # (修改) 与md文件名保持一致，后缀.tex
'FETMX8MPQ-SMARC OKMX8MPQ-SMARC',                                     # (修改) PDF说明书封面标题
'User Hardware Manual',            # (修改) 文档类别 "User Software Manual / Application Note等"
'manual',                             # (不修改) 文档类别，不修改
 False
),
(
'OK-MX8MPQ-SMARC_Linux_User_Compilation_Manual',
'OK-MX8MPQ-SMARC_Linux_User_Compilation_Manual.tex',
'FETMX8MPQ-SMARC OKMX8MPQ-SMARC',
...
'OK-MX8MPQ-SMARC_Linux_User_Manual.tex',
'FETMX8MPQ-SMARC OKMX8MPQ-SMARC',
'User Software Manual',
'manual',
 False 

...
![image-20250822143309090](/../image-20250822143309090.png)

<font style="color:#000000;">Check I accept the terms in the license agreement and click Next.</font>

![image-20250822143348417](/../image-20250822143348417.png)
...
![image-20250822143400028](/../image-20250822143400028.png)

<font style="color:#000000;">Uncheck and click on "Next".</font>

![image-20250822143412982](/../image-20250822143412982.png)

<font style="color:#000000;">Check Add Shortcut and click "Next".</font>

![image-20250822143424261](/../image-20250822143424261.png)

<font style="color:#000000;">Click "Installation"</font>

![image-20250822143436721](/../image-20250822143436721.png)

<font style="color:#000000;">Wait for the installation to complete.</font>

![image-20250822143447090](/../image-20250822143447090.png)
...
![image-20250822143507646](/../image-20250822143507646.png)
...
![](/../1718951630682-5929a683-d5a7-4aba-914c-7ba224385245.png)

Select all compressed files, right-click and extract to the current folder or your own directory:

![](/../1718951630871-696d6c3c-1be3-495f-872b-b234ec827998.png)
...
![image-20250822143638750](/../image-20250822143638750.png)
...
![](/../1718951631269-d55c5375-a6f3-49a1-a67a-c3542de9b480.png)

Turn on this virtual machine after loading is complete to run it and enter the system's interface.

![image-20250822143654401](/../image-20250822143654401.png)
...
![image-20250822143731867](/../image-20250822143731867.png)

Step 2: Select Custom and click “Next”.

![image-20250822143914387](/../image-20250822143914387.png)

Select the compatibility with the corresponding version of VMware, which can be found in Help->About VMware Workstation, and click “Next”.

![image-20250822143937766](/../image-20250822143937766.png)

Select Install the operating system later and click “Next”.

![image-20250822144000637](/../image-20250822144000637.png)

Keep the default settings and click “Next”.

![image-20250822144018961](/../image-20250822144018961.png)

Modify the name and installation location of your virtual machine, and click “Next”.

![image-20250822144322946](/../image-20250822144322946.png)

Configure the number of CPU based on your computer's actual specifications.

![image-20250822144332681](/../image-20250822144332681.png)

Set the memory size according to the actual situation. It is recommended to use 16g

![image-20250822144346105](/../image-20250822144346105.png)
...
![image-20250822144357073](/../image-20250822144357073.png)

The default selection for the IO controller type here is LSI

![image-20250822144413205](/../image-20250822144413205.png)

The default selection here is also SCSI.

![image-20250822144425310](/../image-20250822144425310.png)

Choose to create a new virtual disk here.

![image-20250822144437747](/../image-20250822144437747.png)

Set the disk size to 500G, select the disk provisioning format, and then click “Next”.

![image-20250822144447304](/../image-20250822144447304.png)

Specify the disk file, the default one here is fine.

![image-20250822144504881](/../image-20250822144504881.png)

Click “Finish” by default.

![image-20250822144519822](/../image-20250822144519822.png)

The virtual machine creation is now complete.

![image-20250822144527163](/../image-20250822144527163.png)
...
![](/../1718951641124-ee455983-73cb-43a8-be17-8c031f89c7f2.png)
...
![image-20250822144631586](/../image-20250822144631586.png)

The “Virtual Machine Settings” menu will pop up.

Click on CD/DVD (SATA), select “Use ISO image file,” browse and choose the previously downloaded Ubuntu image, then click “OK” to confirm.

![image-20250822144753076](/../image-20250822144753076.png)

After setting up the image, ensure that the network is available. Then, start the virtual machine and proceed with the installation of the Ubuntu image.

![image-20250822144808934](/../image-20250822144808934.png)

After starting the virtual machine, wait for the installation interface to appear as shown below.

![](/../1718951642091-63b79615-9324-4a49-a408-e868a520ed91.png)
...
![](/../1718951642289-8b188be6-a670-4068-bd06-11b215931677.png)

The default selected language can also be reset at a later stage, after the selection is complete continue.

![](/../1718951642493-eebc2e44-bb26-415f-aed6-75baa52f1a12.png)
...
![image-20250822144913683](/../image-20250822144913683.png)

Once done, enter Ubuntu and the VMware Tools CD will appear on your desktop and click into it.

![](/../1718951644800-57c0b6ec-a192-4929-a456-ab6e3560f46b.png)
...
![](/../1718951644994-ad4636ee-d112-4c34-9430-fa09206597e5.png)
...
![](/../1718951645172-2e3e160c-7bc4-4589-93f5-0bd0163449b4.png)

After the extraction is complete, a file named “vmware-tools-distrib" will appear.

![](/../1718951645424-a5baebfd-d321-4cb2-b740-36e587a06cfc.png)
...
![](/../1718951645591-b2eeca8e-77fb-4ac5-9b9d-8790ce509625.png)
...
![](/../1718951646137-f8d5b537-90fc-458f-a057-1cea0b9a14e6.png)
...
![](/../1718951646841-41afafa7-1af6-44bb-b2ac-87118ffadb23.png)

Then the installation window of the graphical interface will pop up, and install according to the instructions:

![](/../1718951647124-d5514a7e-0883-4fb4-8434-ef21eb43ee4a.png)

![](/../1718951647333-1aeaeb93-ee6e-4170-adc5-c70de75a4fe6.png)

![](/../1718951647531-546d2277-2723-4033-a3b7-20cf832e6e69.png)

![](/../1718951647730-1bd0db08-6c49-49cb-972b-13d74334e5fb.png)
...
![](/../1718951647904-f74602e9-ffa0-4467-a5d5-d0ef9a974857.png)

Click "Next".

![](/../1718951648062-f18dff3a-66f3-4524-bbe3-7fe22817892d.png)

You can set the installation path according to your own habits. It is set by default here, so click "Next".

![](/../1718951648230-95be32f0-e63d-4c47-8f31-ee38ba97ed27.png)

Installation completes, click "Next".

![](/../1718951648450-ce9abe45-dcf6-4c05-b24f-cb3c1f1354e6.png)

![](/../1718951648656-c5ff3037-ad0f-4e76-92a7-6fe19bb4926e.png)

Click "Install" and wait for the installation to complete.

![](/../1718951648849-37a9798d-2b90-446b-80cb-5ed184b46659.png)
...
![](/../1718951649012-a745c94e-d45b-45b8-91fa-96dd5c94c344.png)
...
![](/../1718951655263-0b8cdd0b-b93f-480f-9944-6a645f773702.png)
...
![](/../1737337666329-54e21ada-537d-4e1a-81d3-c4907b792c25.png)
...
![](/../1718951655478-0d01ce2b-df0c-4ce9-bfad-b8025d0e8c42.png)
...
![](/../1718951655653-da370a04-fd55-4c0e-aff5-0f5b40970048.png)
...
![](/../1718951655838-1f361d13-b3cc-4d82-bed2-12f04532e267.png)
